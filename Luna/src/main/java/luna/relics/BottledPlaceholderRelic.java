...
import luna.patches.relics.BottledPlaceholderField;
...
import static luna.LunaBase.makeRelicOutlinePath;
import static luna.LunaBase.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = LunaBase.makeID("BottledPlaceholderRelic");
