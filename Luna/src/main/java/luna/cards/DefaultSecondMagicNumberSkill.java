...
import static luna.LunaBase.makeCardPath;
...
public class DefaultSecondMagicNumberSkill extends AbstractLunaCard {
    ...
    public static final String ID = LunaBase.makeID("DefaultSecondMagicNumberSkill");
    ...
    public static final CardColor COLOR = Luna.Enums.COLOR_GRAY;
