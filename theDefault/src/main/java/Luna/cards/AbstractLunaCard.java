...
public abstract class AbstractLunaCard extends CustomCard {
    ...
    // simply use that in our cards, so long as we put "extends AbstractLunaCard" instead of "extends CustomCard" at the start.
    ...
    public AbstractLunaCard(final String id, final String name, final String img, final int cost, final String rawDescription,
