...
import static Luna.ShinyMoonBase.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = ShinyMoonBase.makeID("IdentityCrisisEvent");
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("LunaResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
