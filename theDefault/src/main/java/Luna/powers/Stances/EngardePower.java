...
public class EngardePower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = ShinyMoonBase.makeID("EngardePower");
    ...
    public EngardePower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void onInitialApplication(){
        if(owner.hasPower(SlashPower.POWER_ID)){
            ...
            AbstractDungeon.actionManager.addToBottom(
                    new ApplyPowerAction(owner, owner, new EngardePower(owner,owner, convert), convert));
        }
    ...
    public AbstractPower makeCopy() {
        return new EngardePower(owner, source, amount);
    }
}
