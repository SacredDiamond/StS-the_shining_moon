...
import Luna.relics.GoddessSpirit;
...
// Scroll down in this file. Change the ID from "Luna:" to "yourModName:" or whatever your heart desires (don't use spaces). Dw, you'll see it.
// In the JSON strings (resources>localization>eng>[all them files] make sure they all go "yourModName:" rather than "Luna". You can ctrl+R to replace in 1 file, or ctrl+shift+r to mass replace in specific files/directories (Be careful.).
...
@SpireInitializer
public class ShinyMoonBase implements
        EditCardsSubscriber,
    ...
    public static final Logger logger = LogManager.getLogger(ShinyMoonBase.class.getName());
    ...
    // Colors (RGB)
    // Character Color
    public static final Color Luna_GRAY = CardHelper.getColor(64.0f, 70.0f, 70.0f);
    ...
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "LunatResources/images/1024/card_default_gray_orb.png";
    ...
    public ShinyMoonBase() {
        ...
        // replace all instances of Luna with yourModID.
        ...
        // Change their locations to reflect your actual ID rather than Luna. They get loaded before getID is a thing.
        logger.info("Done subscribing");

        logger.info("Creating the color " + Luna.Enums.Luna_color.toString());

        BaseMod.addColor(Luna.Enums.Luna_color, Luna_GRAY, Luna_GRAY, Luna_GRAY,
                Luna_GRAY, Luna_GRAY, Luna_GRAY, Luna_GRAY,
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = ShinyMoonBase.class.getResourceAsStream("/IDCheckStrings.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = ShinyMoonBase.class.getResourceAsStream("/IDCheckStrings.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT

        String packageName = ShinyMoonBase.class.getPackage().getName(); // STILL NOT EDIT ZONE
    ...
    public static void initialize() {
        ...
        ShinyMoonBase defaultmod = new ShinyMoonBase();
    ...
    public void receiveEditCharacters() {
        logger.info("Beginning to edit characters. " + "Add " + Luna.Enums.Luna.toString());

        BaseMod.addCharacter(new Luna("the Default", Luna.Enums.Luna),
                THE_DEFAULT_BUTTON, THE_DEFAULT_PORTRAIT, Luna.Enums.Luna);

        receiveEditPotions();
        logger.info("Added " + Luna.Enums.Luna.toString());
    }
    ...
    public void receivePostInitialize() {
        ...
        settingsPanel.addUIElement(new ModLabel("ShinyMoonBase doesn't have any settings! An example of those may come later.", 400.0f, 700.0f,
                settingsPanel, (me) -> {
        }));
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, Luna.Enums.Luna);
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new GoddessSpirit(), Luna.Enums.Luna_color);
        BaseMod.addRelicToCustomPool(new BottledPlaceholderRelic(), Luna.Enums.Luna_color);
        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), Luna.Enums.Luna_color);
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new LunaSecondMagicNumberSkill());
        ...
        BaseMod.addCard(new Engarde());
        BaseMod.addCard(new Slash());
        BaseMod.addCard(new AdaptiveStance());
        ...
        UnlockTracker.unlockCard(LunaSecondMagicNumberSkill.ID);
