...
public class PlaceholderPotion extends AbstractPotion {
    ...
    public static final String POTION_ID = ShinyMoonBase.makeID("PlaceholderPotion");
    ...
    public PlaceholderPotion() {
        // The bottle shape and inside is determined by potion size and color. The actual colors are the main ShinyMoonBase.java
